...
<div class="card mb-4 border-0 shadow-sm" style="background: linear-gradient(135deg, #10b981 0%, #047857 100%); color: white; border-radius:16px;">
            ...
            <div>
                ...
                <div class="fw-bold" style="font-size:1.05rem;">
                    @switch($ticket->status)
                        @case('OPEN')        🔵 Mới gửi (Chờ xử lý)       @break
                        @case('IN_PROGRESS') 🟡 Đang trong quá trình khắc phục @break
                        @case('RESOLVED')    🟢 Đã khắc phục thành công   @break
                        @case('CLOSED')      ⚫ Đã đóng phiếu             @break
                        @case('REOPENED')    🔴 Đã được sinh viên mở lại  @break
                    @endswitch
                </div>
            </div>
        </div>
